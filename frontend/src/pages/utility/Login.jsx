                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    className={`block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 ${
                                ...
                                <button
                                    ...
                                    className="absolute right-2 top-1/2 -translate-y-1/2 text-sm text-cyan-500"
                                >
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full flex items-center justify-center px-4 py-2 bg-cyan-600 text-white rounded-md hover:bg-cyan-700 disabled:opacity-50"
                            >
